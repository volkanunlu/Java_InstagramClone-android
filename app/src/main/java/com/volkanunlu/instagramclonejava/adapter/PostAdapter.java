package com.volkanunlu.instagramclonejava.adapter;
...
import com.volkanunlu.instagramclonejava.databinding.RecyclerRowBinding;
 ...
 @Override
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        Picasso.get().load(postArrayList.get(position).downloadUrl).into(holder.recyclerRowBinding.recyclerViewImageView);
                        //resimi nereden alayım, nereye götürüyim, Picasso kütüphanesi kullanımı
